...
// because of scope the nested function can see and use variables up from its current position.
...
console.log(lowerCaseNames(zooAnimals))
  ...
  */
  ...
  function USApop(arr){
    let total = arr.reduce((accum, item) => {return item.population + accum},0)
    return total;
  }
...
class CubeMaker extends CuboidMaker{
 ...
 const squareish = new CubeMaker({
  length: 5,
  width: 5,
  heigth: 5
 })

 console.log(squareish.cubeVolume());
 console.log(squareish.cubeSurface());
